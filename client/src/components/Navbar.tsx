    ...
    return (
        <nav className="flex justify-between items-center ">
            ...
            <ul className="hidden  md:flex">
                <li className="px-4  cursor-pointer uppercase   hover:scale-105 duration-200 hover:text-indigo-500 hover:font-semibold ">
                    <Link to="/">Home</Link>
                </li>
                <li className="px-4  cursor-pointer uppercase   hover:scale-105 duration-200 hover:text-indigo-500 hover:font-semibold ">
            ...
            {nav ? (
                <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white ">
                    <li className="px-4 cursor-pointer uppercase py-6 text-4xl">
